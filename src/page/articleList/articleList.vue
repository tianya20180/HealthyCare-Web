<template>
	<div>
		  <head-top head-title="我的文章" go-back='true'></head-top>
...
import {searchDoctor,getHotArticle,getArticleByDoctorId} from '../../service/getData'
...
export default {
    ...
    async created(){
	 ...
	 //  let id=this.$route.query.id;
	   ...
	   let res=await getArticleByDoctorId(this.userinfo.id);
	   console.log(res);
